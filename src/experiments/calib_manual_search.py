...
temperatures, nll, avg_conf, ece, mce = LitModel.manual_search_plot(
    bert_clf,
    text_dataloader(val_text_ds),
    model_name="BERT",
    calibration_lr=0.3,
...
LitModel.manual_search_plot(
    vgg16_clf, img_dataloader(val_img_ds), model_name="VGG16", calibration_lr=0.1
)
